...
const MobileBottomNav = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 w-full bg-white pt-3 flex justify-around items-center gap-1 rounded-xl shadow-lg z-50 h-[70px]">
      {[
        { name: "home", icon: <IconHome size={22} />, path: ["/home"] },
        {
          name: "calendar",
