...
const ButtonConfigColor = ({
  ...
  const getButtonStyles = () => {
    switch (buttontype) {
      case "submit":
        return "px-6 py-2 text-sm font-medium text-white bg-gradient-to-r from-accent-500 via-accent-500 to-accent-400 rounded-lg shadow-md hover:from-[#8B78FF] hover:via-accent-600 hover:to-accent-600 transition-all duration-300 ease-in-out transform hover:scale-105";
      case "back":
